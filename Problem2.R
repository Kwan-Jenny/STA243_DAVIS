...
plot_generation = function(gen, raw_df, wh_score="AIC"){
  ...
  # add geomlines for AIC or MDL depending on which was passed into this fn
  if(wh_score=="AIC"){
...
best_score_and_org = function(population, wh_score){
  # Determine best score in the population 
  if(wh_score=="AIC"){
